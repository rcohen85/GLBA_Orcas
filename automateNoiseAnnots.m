...
fileExt = '.flac';
selDir = 'P:\users\cohen_rebecca_rec297\CCB\GLBA\Orcas\EcotypeClassfier\Training\IndividualSelTables\2020';
...
for i=1:500:numel(noCallFiles)
    ...
    saveName = fullfile(selDir,'Noise',strrep(noCallFiles{i},'.wav','.txt'));
